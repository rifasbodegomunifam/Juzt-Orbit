<?php
/**
 * Template Name: Landing Page Diciembre
...
$template_content = $template->get_json_template('page-landing-page-diciembre');
$context = Timber::context();
$context['order'] = $template_content['order'];
$context['sections'] = $template_content['sections'];

Timber::render('templates/page-landing-page-diciembre.twig', $context); 
